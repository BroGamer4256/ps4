...
SRC = src/mod.cpp src/SigScan.cpp src/helpers.c src/exit.cpp src/types.cpp src/divaFuncs.cpp tomlc99/toml.c minhook/src/buffer.c minhook/src/hook.c minhook/src/trampoline.c minhook/src/hde/hde32.c minhook/src/hde/hde64.c
